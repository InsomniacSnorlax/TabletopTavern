...
A released game made by one person. I'm sharing the code because I think there's genuine value in seeing what a shipped indie project actually looks like. Not a tutorial, not a polished open-source showcase, but the real thing.

That means you'll find:

- Systems that evolved over years and show their age
- Architectural decisions that made sense at the time and don't hold up
- A few `oldSpells/` folders and `old/` directories I never got around to deleting
- Some genuinely good patterns mixed in with some stuff I'd do very differently today

## Honest notes

I know the code has rough spots. Imperfect code that's out in the world beats perfect code that never leaves your hard drive.
...
What you *can* do is read through the code, study how the systems fit together, and take anything useful for your own work.
